...
@property(nonatomic) VIResourceLoaderManager *resourceLoaderManager;
...
@interface CachedVideoPlayerPlugin ()
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel =
      [FlutterMethodChannel methodChannelWithName:@"flutter_cached_video_player"
...
- (void)onPlayerSetup:(FLTVideoPlayer*)player
  ...
  FlutterEventChannel* eventChannel = [FlutterEventChannel
      eventChannelWithName:[NSString stringWithFormat:@"flutter_cached_video_player/videoEvents%lld",
                                                      textureId]
